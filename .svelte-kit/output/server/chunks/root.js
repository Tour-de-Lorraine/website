import { H as HYDRATION_ERROR, j as get_descriptor, k as define_property, l as is_array, m as HYDRATION_START, n as HYDRATION_END, o as array_from, q as is_passive_event, r as render, a as push$1, b as setContext, p as pop$1 } from "./index2.js";
const DERIVED = 1 << 1;
const EFFECT = 1 << 2;
  ...
  if ((flags & MAYBE_DIRTY) !== 0) {
    ...
    if (dependencies !== null) {
      ...
      for (i = 0; i < dependencies.length; i++) {
        ...
        if (is_unowned && current_effect !== null && !current_skip_reaction && !dependency?.reactions?.includes(reaction)) {
